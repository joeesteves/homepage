...
const description = (
  <div className="section__description">
    ...
    <p>
      Beyond TypeScript, I bring valuable experience in Elixir/Phoenix and Ruby on Rails, having maintained and developed over large codebases. I'm passionate about programming in general (my personal programming bookshel can confirm :)) I keep learning almost every day, new patters, blockchain, languages, paradigms, IA tooling since this is what I love to do.
    </p>
  </div>
);
